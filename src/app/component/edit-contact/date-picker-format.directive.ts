...
const DATE_VALUE_PROVIDER: Provider = {
  ...
  useExisting: forwardRef(() => DatePickerFormatDirective),
  multi: true
}
...
export class DatePickerFormatDirective implements ControlValueAccessor{
  ...
  writeValue(obj: any): void {
      if (obj instanceof Date) {
        this.element.nativeElement.value = obj.toISOString().split('T')[0];
      }
    }
